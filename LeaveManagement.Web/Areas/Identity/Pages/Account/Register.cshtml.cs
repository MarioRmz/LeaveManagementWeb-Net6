...
namespace LeaveManagement.Web.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public async Task OnGetAsync(string returnUrl = null)
        {
            ...
            //Aqui hay un return Page(); implicito que ocurre una vez se haga toda la logica dentro de este metodo,
            //porque no necesita regresar nada per se
        }
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                user.DateOfBirth = Input.DateOfBirth ?? default; //<- Null safe
                user.DateJoined = Input.DateJoined ?? default; //<- Null safe
                ...
                if (result.Succeeded)
                {
                    ...
                    //Se asigna un rol ya existente
                    await _userManager.AddToRoleAsync(user, Roles.User); //"User");
                    ...
                    //Implementamos esto por nuestras clases y papercut-smtp
